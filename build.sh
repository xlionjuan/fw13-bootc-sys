...
# Install
dnf5 install -y ptyxis cloudflare-warp zerotier-one screen tuned waydroid rustdesk ntpd-rs sudo-rs wireshark koji rclone gcm-core mullvad-vpn helium-bin zed
